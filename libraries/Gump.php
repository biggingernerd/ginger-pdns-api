		...
		foreach($this->errors as $e) {
			...
			switch($e['rule']) {
				...
				case 'validate_street_address':
					...
					break;
				case 'validate_checkIfDomainNameIsFree':
					$resp[] = "The domain <span class=\"$field_class\">$field</span> is already in the system";
					break;
				case 'validate_checkIfDomainNameExists':
					$resp[] = "The domain <span class=\"$field_class\">$field</span> is not found in the system";
					break;
				case 'validate_checkIfDomainIdExists':
					$resp[] = "The domain with this ID is not found in the system";
					break;
